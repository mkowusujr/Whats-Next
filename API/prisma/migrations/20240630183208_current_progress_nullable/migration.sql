...
CREATE TABLE "new_media" (
    ...
    CONSTRAINT "media_currentProgressId_fkey" FOREIGN KEY ("currentProgressId") REFERENCES "progress" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_media" ("createdAt", "creator", "currentProgressId", "duration", "id", "imgLink", "isDeleted", "mediaLink", "mediaTypeId", "releaseDate", "seriesId", "storage", "subTitle", "summary", "title", "updatedAt") SELECT "createdAt", "creator", "currentProgressId", "duration", "id", "imgLink", "isDeleted", "mediaLink", "mediaTypeId", "releaseDate", "seriesId", "storage", "subTitle", "summary", "title", "updatedAt" FROM "media";
DROP TABLE "media";
